  ...
  <section class="content">
    ...
    <div class="box">
        ...
        <div class="nav-tabs-custom">
          ...
          <div class="tab-content">
            <div class="tab-pane <?php echo $class = ($tab == 'biodata') ? "active" : NULL ; ?>" id="biodata">
              <!-- form start -->
              <?php echo form_open_multipart('adminsiswa/insertbiodata', 'class="form-horizontal"'); ?>
              <div class="box-body">
                <div class="row">
                  <div class="col-md-6">
          ...
          <div class="tab-pane <?php echo $class = ($tab == 'paket') ? "active" : NULL ; ?>" id="Paket">
            <?php echo form_open('adminsiswa/insertpaket', 'class="form-horizontal"'); ?>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <?php if ($paket['nama_paket']) {?>
                      <input class="form-control" type="text" disabled="" value="<?php echo $paket['nama_paket'] . " s/d " . nice_date($paket['batas_paket'], 'd-m-Y') ?>"></input>
                    <?php
                    } else {?>
      ...
      <div class="tab-pane <?php echo $class = ($tab == 'administrasi') ? "active" : NULL ; ?>" id="Administrasi">
        <!-- form start -->
        <?php echo form_open('adminsiswa/update_administrasi', 'class="form-horizontal"'); ?>
...
<div class="modal-dialog">
  <div class="register-box">
    <div class="register-box-body">
      ...
      <?php echo form_open('adminsiswa/kirimkonfirmasi'); ?>
