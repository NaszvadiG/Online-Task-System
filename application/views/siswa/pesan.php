  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <?php echo $this->session->flashdata('pesan2'); ?>      
          ...
          <a class="btn bg-yellow" href="<?php echo site_url('adminsiswa/inbox'); ?>">
            <i class="fa fa-google-wallet"></i> Inbox
          </a>  
          <a class="btn bg-blue" href="<?php echo site_url('adminsiswa/outbox'); ?>">
...
<div class="modal-dialog">
  <div class="register-box">
    <div class="register-box-body">
      ...
      <?php echo form_open('adminsiswa/kirimpesan'); ?>
