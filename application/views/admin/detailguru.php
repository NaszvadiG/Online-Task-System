...
<!--       <div class="box-header">
      ...
      <div class="box-body">
        <form role="form">
          <div class="col-md-6">
            <img src="<?php echo base_url() ?>assets/image/guru/<?php echo $isi['foto']; ?>" class="img-circle center-block gambar" alt="User Image">
          ...
          <table id="datatable" class="table table-bordered table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><a href="<?php echo site_url("adminutama/hapuskelas/". $isi['id_kelas'] ."/". $isi['id_akun'] .""); ?>" class="badge bg-red ask">Hapus</a></td>
              </tr>
              <?php
            }
            ?>
