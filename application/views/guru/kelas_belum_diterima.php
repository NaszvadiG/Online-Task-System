...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="box-header">
      ...
      <a class="btn bg-yellow" href="<?php echo site_url('adminguru/detailkelas/'.$id_kelas.'/diterima'); ?>">
        <i class="fa fa-google-wallet"></i> Diterima
      </a>  
      <a class="btn bg-blue" href="<?php echo site_url('adminguru/detailkelas/'.$id_kelas.'/belum_diterima'); ?>">
        <i class="fa fa-ils"></i> Belum Diterima
      </a>   
      <a class="btn bg-red" href="<?php echo site_url('adminguru/detailkelas/'.$id_kelas.'/ditolak'); ?>">
        ...
        <table id="datatable" class="table table-bordered table-striped">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="<?php echo site_url(); ?>/adminguru/tolakkelas/<?php echo $isi['id_kelas_siswa']; ?>/<?php echo $isi['id_kelas']; ?>/belum_diterima" class="btn bg-red ask-tolak">Tolak</a>

                <a href="<?php echo site_url(); ?>/adminguru/terimakelas/<?php echo $isi['id_kelas_siswa']; ?>/<?php echo $isi['id_kelas']; ?>/belum_diterima" class="btn bg-green ask-tolak">Terima</a>
