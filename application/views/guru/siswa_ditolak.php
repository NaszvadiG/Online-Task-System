        ...
        <table id="datatable" class="table table-bordered table-striped">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="<?php echo site_url(); ?>/adminguru/hapus_kelas_siswa/<?php echo $isi['id_kelas_siswa']; ?>" class="btn btn-danger ask">Hapus</a>
                <a href="<?php echo site_url(); ?>/adminguru/terimasiswa/ditolak/<?php echo $isi['id_kelas_siswa']; ?>" class="btn btn-success ask-tolak">Terima</a>
