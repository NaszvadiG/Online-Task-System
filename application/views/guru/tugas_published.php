        ...
        <table id="datatable" class="table table-bordered table-striped">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
              <a href="<?php echo site_url('adminguru/nilai_tugas/' . $isi['id_soal'] . ''); ?>" class="badge bg-purple">Detail</a>
              <a href="<?php echo site_url('adminguru/hapus_tugas/' . $isi['id_soal'] . ''); ?>" class="badge bg-red ask">Hapus</a>
              </td>
            </tr>
            <?php
          }
