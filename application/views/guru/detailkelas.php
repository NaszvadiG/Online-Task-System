        ...
        <table id="datatable" class="table table-bordered table-striped">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="<?php echo site_url(); ?>/adminguru/tolakkelas/<?php echo $isi['id_kelas_siswa']; ?>/<?php echo $isi['id_kelas']; ?>" class="btn bg-red ask-tolak">Tolak</a>

                <a href="<?php echo site_url(); ?>/adminguru/terimakelas/<?php echo $isi['id_kelas_siswa']; ?>/<?php echo $isi['id_kelas']; ?>" class="btn bg-green ask-tolak">Terima</a>
